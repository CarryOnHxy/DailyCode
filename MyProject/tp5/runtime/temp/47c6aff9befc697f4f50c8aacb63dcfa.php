						...
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form"  method="post">
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 所属部门 </label>
									<div class="col-sm-9">
										<select class="rcol-xs-10 col-sm-5" name="departid" required>
											...
											<option value="<?php echo $val['id']; ?>" <?php if($info['depart_id'] == $val['id']): ?>selected<?php endif; ?>><?php echo $val['depart_name']; ?></option>
								...
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 职位名 </label>
									<div class="col-sm-9">
										<input type="text" placeholder="职位名" name="name" class="col-xs-10 col-sm-5" value="<?php echo $info['position_name']; ?>" required>
										<span class="help-inline col-xs-12 col-sm-7">
											<span class="middle">职位名称，不能为空。</span>
										</span>
									</div>
								</div>
								<div class="space-4"></div>

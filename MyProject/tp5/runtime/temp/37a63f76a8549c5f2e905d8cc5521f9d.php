					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								...
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('department/add'); ?>">新增</a>
								</div>
										...
										<?php foreach($list as $item): ?>
											<tr>
												...
												<td class="text-center">
													<a href="<?php echo url('position/index',array('did'=>$item['id'])); ?>" class="btn btn-warning">职位列表</a>

													<a href="<?php echo url('department/edit',array('id'=>$item['id'])); ?>" class="btn btn-primary">修改</a>

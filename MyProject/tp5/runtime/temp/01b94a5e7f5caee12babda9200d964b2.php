<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:66:"D:\wamp64\www\tp5\public/../application/index\view\rule\index.html";i:1536285626;s:57:"D:\wamp64\www\tp5\application\index\view\common\head.html";i:1536111014;s:59:"D:\wamp64\www\tp5\application\index\view\common\navbar.html";i:1536307337;s:60:"D:\wamp64\www\tp5\application\index\view\common\sidebar.html";i:1536305183;s:61:"D:\wamp64\www\tp5\application\index\view\common\settings.html";i:1536110104;s:59:"D:\wamp64\www\tp5\application\index\view\common\footer.html";i:1536109867;s:55:"D:\wamp64\www\tp5\application\index\view\common\js.html";i:1536199130;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue">
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li>
								<a href="<?php echo url('depart/info'); ?>"><i class="ace-icon fa fa-user"></i>个人资料</a>
							</li>
							<li class="divider"></li>
							<li>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('rule/add'); ?>">新增</a>
								</div>
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$rule): ?>
										<tr>
											
											<td><?php echo $rule['rule_name']; ?></td>
											<td><?php echo $rule['rule_address']; ?></td>
											<td><i class="menu-icon fa fa-<?php echo $rule['rule_icon']; ?>"></i></td>
											<td class="center"><?php echo $rule['is_menu']==1?'显示' : '不显示'; ?></td>
											<td class="center"><?php echo $rule['status']==1?'启用' : '禁用'; ?></td>
											<td><?php echo $rule['sort']; ?></td>
											<td class="center">
											<a href="<?php echo url('rule/edit',array('id'=>$rule['id'])); ?>" class="btn btn-primary">修改</a>&nbsp;
											<a class="btn btn-danger" href="javascript:;" title="删除" onclick="del(this)" data-id="<?php echo $rule['id']; ?>">删除</a>
											</td>
										</tr>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>

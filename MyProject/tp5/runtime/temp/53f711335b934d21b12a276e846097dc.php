						...
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form" method="post">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="rcol-xs-10 col-sm-5" name="departid" required>
											...
											<option value="<?php echo $departinfo['id']; ?>"><?php echo $departinfo['depart_name']; ?></option>
											<?php endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="职位名" name="name" class="col-xs-10 col-sm-5" value="" required>

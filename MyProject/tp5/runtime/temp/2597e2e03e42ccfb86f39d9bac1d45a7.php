<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:70:"D:\wamp64\www\tp5\public/../application/index\view\employee\index.html";i:1536297898;s:57:"D:\wamp64\www\tp5\application\index\view\common\head.html";i:1536111014;s:59:"D:\wamp64\www\tp5\application\index\view\common\navbar.html";i:1536310521;s:60:"D:\wamp64\www\tp5\application\index\view\common\sidebar.html";i:1536309430;s:61:"D:\wamp64\www\tp5\application\index\view\common\settings.html";i:1536110104;s:59:"D:\wamp64\www\tp5\application\index\view\common\footer.html";i:1536109867;s:55:"D:\wamp64\www\tp5\application\index\view\common\js.html";i:1536199130;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?php echo !empty($info['user_img'])?$info['user_img'] :'/static/images/user.png'; ?>" alt="admin" />
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								...
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('employee/add'); ?>">新增</a>
								</div>
										...
										<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
											<tr>
												...
												<td class="text-center">
													<a href="<?php echo url('employee/edit',array('id'=>$item['id'])); ?>" class="btn btn-primary">修改</a>
													<a href="javascript:;" data-id=<?php echo $item['id']; ?> onclick="del(this)" class="btn btn-danger">删除</a>
												</td>
											</tr>  
										<?php endforeach; endif; else: echo "" ;endif; ?>	                              
										</tbody>
	...
	<script type="text/javascript">
		function del(obj){
			...
			layer.confirm('确定要删除此员工吗？删除后将不可恢复',function(){
				$.post('<?php echo url("employee/delete"); ?>',{id:id},function(res){
					if(res.code == 1){

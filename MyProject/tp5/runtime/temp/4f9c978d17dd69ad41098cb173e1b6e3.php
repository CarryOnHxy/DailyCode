			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?php echo url('department/index'); ?>">部门管理</a>
						</li>
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="form" name="form"  method="post">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 部门名 </label>
									<div class="col-sm-9">
										<input type="text" placeholder="部门名" class="col-xs-10 col-sm-5" value="<?php echo $info['depart_name']; ?>" name="depart_name">
										
										<span class="help-inline col-xs-12 col-sm-7">
											<span class="middle">部门名称，不能为空。</span>
										</span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
										<label>
											是:<input class="ace" type="radio" name="status" <?php if($info['status'] == '1'): ?>checked<?php endif; ?>  value='1' />
											<span class="lbl"></span>
										</label>

										<label>
											否:<input class="ace" type="radio" name="status"  <?php if($info['status']==0): ?>checked<?php endif; ?>  value='0' />
											<span class="lbl"></span>
										</label>
								...
								<div class="col-md-offset-2 col-md-9">
									<button class="btn btn-danger submit" type="button"><i class="icon-ok bigger-110"></i>重置</button>
									<button class="btn btn-success submit" type="submit"><i class="icon-ok bigger-110"></i>提交</button>
								</div>

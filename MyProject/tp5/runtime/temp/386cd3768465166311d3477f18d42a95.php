<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:70:"D:\wamp64\www\tp5\public/../application/index\view\position\index.html";i:1536200279;s:57:"D:\wamp64\www\tp5\application\index\view\common\head.html";i:1536111014;s:59:"D:\wamp64\www\tp5\application\index\view\common\navbar.html";i:1536307852;s:60:"D:\wamp64\www\tp5\application\index\view\common\sidebar.html";i:1536305183;s:61:"D:\wamp64\www\tp5\application\index\view\common\settings.html";i:1536110104;s:59:"D:\wamp64\www\tp5\application\index\view\common\footer.html";i:1536109867;s:55:"D:\wamp64\www\tp5\application\index\view\common\js.html";i:1536199130;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue">
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li>
								<a href="<?php echo url('depart/info',['real_name'=>\think\Session::get('userinfo.real_name')]); ?>"><i class="ace-icon fa fa-user"></i>个人资料</a>
							</li>
							<li class="divider"></li>
							<li>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<?php if(!(empty($departinfo) || (($departinfo instanceof \think\Collection || $departinfo instanceof \think\Paginator ) && $departinfo->isEmpty()))): ?>
						<li>
							<a href="<?php echo url('department/index'); ?>"><?php echo $departinfo['depart_name']; ?></a>
						</li>
						<?php endif; ?>
						<li>
							<a href="<?php echo url('position/index'); ?>">职位管理</a>
						</li>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<?php if(!(empty($departinfo) || (($departinfo instanceof \think\Collection || $departinfo instanceof \think\Paginator ) && $departinfo->isEmpty()))): ?>
									<a class="btn btn-info" href="<?php echo url('position/add',array('did'=>$departinfo['id'])); ?>">新增</a>
									<?php else: ?>
									<a class="btn btn-info" href="<?php echo url('position/add'); ?>">新增</a>
									<?php endif; ?>
								</div>
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无职位信息" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
										<tr>
											
											<!-- <td></td> -->
											<td><?php echo $item['depart_name']; ?></td>
											<td><?php echo $item['position_name']; ?></td>
											<td>
												<a href="#"><?php echo $item['status']==1?'启用' : '禁用'; ?></a>
											</td>
											<td class="center">
												<a href="<?php echo url('position/edit',array('id'=>$item['id'])); ?>" class="btn btn-primary">修改</a>
												<a href="javascript:;" class="btn btn-danger" onclick="del(this)" data-id="<?php echo $item['id']; ?>">删除</a>
											</td>
										</tr>                  
										<?php endforeach; endif; else: echo "暂无职位信息" ;endif; ?>              
									</tbody>
								</table>
	...
	<script type="text/javascript">
		function del(obj){
			...
			layer.confirm('确定要删除此职位吗？删除后将不可恢复',function(){
				...
				$.post('<?php echo url("position/delete"); ?>',{pid:id},function(res){
					console.log(res);
					if(res.code == 1){
						console.log(1);
						layer.alert(res.msg,{icon:1},function(index){
							...
							layer.close(index);
							location.href="<?php echo url('position/index'); ?>"

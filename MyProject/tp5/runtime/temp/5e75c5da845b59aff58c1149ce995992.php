						...
						<div class="col-xs-12">
							<form class="form-horizontal" id="form" name="form" method="post">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="rcol-xs-10 col-sm-5" value="" name="role_name" required>
												...
												<div class="widget-box">
													<div class="widget-header">
														<h4 class="widget-title">
															<label>
																<input name="role_rules[]" class="ace ace-checkbox-2 father" type="checkbox" value="<?php echo $rule['id']; ?>"/>
													...
													<div class="widget-body">
														<div class="widget-main row">
															...
															<label class="col-xs-3">
																<input name="role_rules[]" class="ace ace-checkbox-2 children" type="checkbox" value="<?php echo $scrule['id']; ?>"/>
